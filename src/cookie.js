...
listTable.addEventListener('click', (e) => {
    if (e.target.innerHTML === 'удалить') {
        const cookieToDelete = e.target.parentElement.firstElementChild.innerHTML;
        const date = new Date();
...
function isMatching(chunk, full) {
...
function fillInTable() {
    ...
    for (let x of Object.getOwnPropertyNames(cookie)) {
        if (isMatching(filter, [x, cookie[x]])) {
